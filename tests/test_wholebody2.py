...
class WholeBody2ScaffoldTestCase(unittest.TestCase):
    ...
    def test_wholebody2_core(self):
        ...
        self.assertEqual(848, mesh3d.getSize())
        mesh2d = fieldmodule.findMeshByDimension(2)
        self.assertEqual(2766, mesh2d.getSize())
        mesh1d = fieldmodule.findMeshByDimension(1)
        self.assertEqual(3027, mesh1d.getSize())
        nodes = fieldmodule.findNodesetByFieldDomainType(Field.DOMAIN_TYPE_NODES)
        self.assertEqual(1110, nodes.getSize())
        ...
        tol = 1.0E-6
        assertAlmostEqualList(self, minimums, [0.0, -1.815, -0.611347], tol)
        assertAlmostEqualList(self, maximums, [7.813, 1.829, 0.707], tol)
        ...
        self.assertAlmostEqual(surfaceArea, 63.41527914317107, delta=tol)
        result, volume = volumeField.evaluateReal(fieldcache, 1)
        self.assertEqual(result, RESULT_OK)
        self.assertAlmostEqual(volume, 5.83672625822755, delta=tol)
    ...
    def test_wholebody2_tube(self):
        ...
        mesh2d = fieldmodule.findMeshByDimension(2)
        self.assertEqual(1350, mesh2d.getSize())
        mesh1d = fieldmodule.findMeshByDimension(1)
        self.assertEqual(1723, mesh1d.getSize())
        nodes = fieldmodule.findNodesetByFieldDomainType(Field.DOMAIN_TYPE_NODES)
        self.assertEqual(702, nodes.getSize())
        datapoints = fieldmodule.findNodesetByFieldDomainType(Field.DOMAIN_TYPE_DATAPOINTS)
        self.assertEqual(0, datapoints.getSize())
        ...
        result, surfaceArea = surfaceAreaField.evaluateReal(fieldcache, 1)
        self.assertEqual(result, RESULT_OK)
        self.assertAlmostEqual(surfaceArea, 62.17526708322486, delta=tol)
        result, volume = volumeField.evaluateReal(fieldcache, 1)
        self.assertEqual(result, RESULT_OK)
        self.assertAlmostEqual(volume, 2.9294427675154546, delta=tol)